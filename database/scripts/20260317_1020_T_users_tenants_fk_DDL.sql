...
-- Description: Add deferred foreign keys between auth.users and tenant.tenants.
--              These cannot live in the original CREATE TABLE scripts because
--              users references tenants and tenants references users (circular).
